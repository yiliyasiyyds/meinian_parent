...
public class QiniuUtils {
    ...
    public  static String accessKey = "6gtyAwiAJ3KtPyykhVs_Zc8Q-Zhw5S2dfd9Hb42k";
    public  static String secretKey = "bBbuXnQRztgpbeiR3UQo6t9n5vTfweIusb2qUP0C";
    public  static String bucket = "sht-meinian";
