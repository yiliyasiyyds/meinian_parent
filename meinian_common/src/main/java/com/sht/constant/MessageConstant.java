...
public class MessageConstant {
    ...
    public static final String VALIDATECODE_TIMEOUT_ERROR = "验证码已失效";
    ...
    public static final String ADD_ADDRESS_FAIL = "地址添加失败";
    public static final String ADD_ADDRESS_SUCCESS = "地址添加成功";
    public static final String DELETE_ADDRESS_FAIL = "地址删除失败";
    public static final String DELETE_ADDRESS_SUCCESS = "地址删除成功";
}